...
export function WorkforceCrowd() {
  return (
    <section className="relative h-[640px] w-full overflow-hidden bg-navy-950 text-[#faf7f0] sm:h-[720px]">
      ...
      <div className="relative z-10 mx-auto grid max-w-5xl gap-4 px-6 pt-20 text-center sm:pt-24">
        ...
        <h2 className="font-display text-3xl font-semibold tracking-tight text-[#faf7f0] sm:text-5xl">
          The hands behind every handover.
        </h2>
        <p className="mx-auto max-w-2xl text-balance text-sm text-[#faf7f0]/65 sm:text-base">
